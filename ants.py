        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                if hasattr(self.ant, 'container') and self.ant.container:
                    ...
                    if not isinstance(insect, QueenAnt) or insect.realQueen == False:
                        self.ant = None
            else:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        location = self.place
        squares = 0
        while squares < self.min_range:
            location = location.entrance
            squares += 1
        while location != hive and squares < self.max_range:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            bees_list = []
            former_bees = list(location.bees)
            for bee in former_bees:
                bee.reduce_armor(self.damage)
                if bee.place != None:
                    bees_list.append(bee)
            location.bees = bees_list
        # END Problem 4
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, colony):
        ...
        bees_list = []
        former_bees = list(self.place.bees)
        for bee in former_bees:
            bee.reduce_armor(self.damage)
            if bee.place != None:
                bees_list.append(bee)
...
class QueenAnt(ScubaThrower): 
    ...
    def __init__(self):
        # BEGIN Problem 13
        Ant.__init__(self)
        QueenAnt.number_of_queen_implements += 1
        if self.number_of_queen_implements > 1:
    ...
    def action(self, colony):
        ...
        if self.realQueen == False:
            ...
            while location.exit != None:
                ...
                if location.ant != None and not location.ant in self.ants:
                    self.ants.append(location.ant)
                    location.ant.damage = location.ant.damage * 2
                if location.ant != None and location.ant.container == True and location.ant.ant != None and not location.ant.ant in self.ants:
                    self.ants.append(location.ant.ant)
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        Insect.reduce_armor(self,amount)
        if self.armor <= 0 and self.realQueen:
            bees_win()
